...
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MAX
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MIN
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MAX
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MIN
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MAX
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MIN
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.calculateCellSignalLevel
import com.cadrikmdev.connectivity.domain.SignalStrengthInfo.Companion.calculateNRSignalLevel
import com.cadrikmdev.connectivity.domain.SignalStrengthInfoCommon
...
import com.cadrikmdev.connectivity.domain.mobile.band.BandCalculationUtil
import com.cadrikmdev.connectivity.domain.mobile.band.CellBand
import com.cadrikmdev.connectivity.domain.mobile.band.CellBand.Companion.fromChannelNumber
import com.cadrikmdev.connectivity.domain.mobile.signal.SignalStrengthInfoGsm
import com.cadrikmdev.connectivity.domain.mobile.signal.SignalStrengthInfoLte
import com.cadrikmdev.connectivity.domain.mobile.signal.SignalStrengthInfoNr
...
fun ICell.toCellNetworkInfo(
    ...
    return CellNetworkInfo(
        ...
        nrConnectionState = if (dataTelephonyManager != null) {
            com.cadrikmdev.connectivity.presentation.mobile_network.util.NrConnectionStateResolver.getNRConnectionState(
