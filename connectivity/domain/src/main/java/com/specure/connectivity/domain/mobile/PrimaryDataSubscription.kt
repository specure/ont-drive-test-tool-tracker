...
enum class PrimaryDataSubscription(
    ...
    companion object {
        ...
        fun resolvePrimaryDataSubscriptionID(
            ...
            return when {
                dataSubscriptionId == INVALID_SUBSCRIPTION_ID || cellSubscriptionId == INVALID_SUBSCRIPTION_ID -> UNKNOWN
                dataSubscriptionId != INVALID_SUBSCRIPTION_ID && cellSubscriptionId == dataSubscriptionId -> TRUE
                else -> FALSE
            }
        }
    }
