...
import com.cadrikmdev.core.presentation.designsystem.CrossIcon
...
import com.cadrikmdev.core.presentation.designsystem.components.RuniquePasswordTextField
import com.cadrikmdev.core.presentation.designsystem.components.RuniqueTextField
...
fun RegisterScreenRoot(
    ...
    RegisterScreen(
        ...
        onAction = { action ->
            when (action) {
                RegisterAction.OnLoginClick -> onSingInClick()
...
private fun RegisterScreen(
    ...
    GradientBackground {
        Column(
            ...
            RuniqueTextField(
                state = state.email, startIcon = EmailIcon, endIcon = if (state.isEmailValid) {
                    CheckIcon
                } else {
                    null
                },
