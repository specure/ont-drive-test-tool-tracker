...
class CellBandData(
    ...
    fun getFrequencyDL(step: Double, channel: Int): Double {
        ...
        var frequency =
            this.downloadFrequencyLowerBound + step * (channel - (this.uploadChannelLowerBound - channelOffset))
 ...
 */
val nrBands: Set<CellBandData> = mutableSetOf<CellBandData>().apply {
 ...
 * latest update V18.1.0 (2023-03)
 */
val lteBands: Set<CellBandData> = mutableSetOf<CellBandData>().apply {
 ...
 */
val umtsBands: Set<CellBandData> = mutableSetOf<CellBandData>().apply {
 ...
 * order by priority (if one uarfcn is contained in multiple bands)
 */
val gsmBands: Set<CellBandData> = mutableSetOf<CellBandData>().apply {
