...
package com.cadrikmdev.core.domain.connectivity.mobile.band;
...
public class BandCalculationUtil {
    ...
    public static abstract class Band {
        ...
        public boolean containsULFrequency(double frequencyMHz) {
            return frequencyMHz >= upload_frequency_lower_bound && frequencyMHz <= upload_frequency_upper_bound;
        }

        public boolean containsDLFrequency(double frequencyMHz) {
            return frequencyMHz >= download_frequency_lower_bound && frequencyMHz <= download_frequency_upper_bound;
        }
    ...
    public static class NRBand extends Band {
        ...
        protected NRBand(int band, double upload_frequency_lower_bound, double upload_frequency_upper_bound, double download_frequency_lower_bound, double download_frequency_upper_bound, String informal_name) {
            super(band, upload_frequency_lower_bound, upload_frequency_upper_bound, download_frequency_lower_bound, download_frequency_upper_bound, 0, 0, 0, informal_name);
        }
