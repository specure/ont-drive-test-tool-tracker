...
enum class ServerNetworkType(
    ...
    TYPE_2G_GSM(1, "2G (GSM)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.GSM),
    TYPE_2G_EDGE(2, "2G (EDGE)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.EDGE),
    TYPE_3G_UMTS(3, "3G (UMTS)", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.UMTS),
    TYPE_2G_CDMA(4, "2G (CDMA)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.CDMA),
    TYPE_2G_EVDO_0(5, "2G (EVDO_0)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.EVDO_0),
    TYPE_2G_EVDO_A(6, "2G (EVDO_A)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.EVDO_A),
    TYPE_2G_1xRTT(7, "2G (1xRTT)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType._1xRTT),
    TYPE_3G_HSDPA(8, "3G (HSDPA)", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSDPA),
    TYPE_3G_HSUPA(9, "3G (HSUPA)", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSUPA),
    TYPE_3G_HSPA(10, "3G (HSPA)", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSPA),
    TYPE_2G_IDEN(11, "2G (IDEN)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.IDEN),
    TYPE_2G_EVDO_B(12, "2G (EVDO_B)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.EVDO_B),
    TYPE_4G_LTE(13, "4G (LTE)", NetworkType.TYPE_4G, TransportType.CELLULAR, MobileNetworkType.LTE),
    TYPE_2G_EHRPD(14, "2G (EHRPD)", NetworkType.TYPE_2G, TransportType.CELLULAR, MobileNetworkType.EHRPD),
    TYPE_3G_HSPA_P(15, "3G (HSPA+)", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSPAP),
    TYPE_4G_LTE_CA(19, "4G (LTE CA)", NetworkType.TYPE_4G, TransportType.CELLULAR, MobileNetworkType.LTE_CA),
    TYPE_5G_NR(20, "5G (NR)", NetworkType.TYPE_5G, TransportType.CELLULAR, MobileNetworkType.NR_SA),
    TYPE_5G_NR_NSA(41, "5G (NSA)", NetworkType.TYPE_5G_NSA, TransportType.CELLULAR, MobileNetworkType.NR_NSA),
    ...
    TYPE_WLAN(99, "WLAN", NetworkType.TYPE_WLAN, TransportType.WIFI, null),
    TYPE_2G_3G(101, "2G/3G", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSUPA),
    TYPE_3G_4G(102, "3G/4G", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSUPA),
    TYPE_2G_4G(103, "2G/4G", NetworkType.TYPE_4G, TransportType.CELLULAR, MobileNetworkType.EVDO_A),
    TYPE_2G_3G_4G(104, "2G/3G/4G", NetworkType.TYPE_4G, TransportType.CELLULAR, MobileNetworkType.LTE),
    TYPE_MOBILE(105, "MOBILE", NetworkType.TYPE_3G, TransportType.CELLULAR, MobileNetworkType.HSUPA),
    TYPE_ETHERNET(106, "Ethernet", NetworkType.TYPE_LAN, TransportType.ETHERNET, null),
