package com.cadrikmdev.core.mobile_network.util
...
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MAX
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MIN
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.calculateCellSignalLevel
import com.cadrikmdev.core.domain.networking.SignalStrengthInfo.Companion.calculateNRSignalLevel
import com.cadrikmdev.core.domain.networking.SignalStrengthInfoCommon
import com.cadrikmdev.core.domain.networking.TransportType
import com.cadrikmdev.core.domain.networking.mobile.CellNetworkInfo
import com.cadrikmdev.core.domain.networking.mobile.CellTechnology
import com.cadrikmdev.core.domain.networking.mobile.MobileNetworkType
import com.cadrikmdev.core.domain.networking.mobile.NrConnectionState
import com.cadrikmdev.core.domain.networking.mobile.PrimaryDataSubscription
import com.cadrikmdev.core.domain.networking.mobile.band.BandCalculationUtil
import com.cadrikmdev.core.domain.networking.mobile.band.CellBand
import com.cadrikmdev.core.domain.networking.mobile.band.CellBand.Companion.fromChannelNumber
import com.cadrikmdev.core.domain.networking.mobile.band.CellChannelAttribution
import com.cadrikmdev.core.domain.networking.mobile.signal.SignalStrengthInfoGsm
import com.cadrikmdev.core.domain.networking.mobile.signal.SignalStrengthInfoLte
import com.cadrikmdev.core.domain.networking.mobile.signal.SignalStrengthInfoNr
...
fun ICell.toRecords(
    ...
    val cellTechnologyFromNetworkType =
        com.cadrikmdev.core.domain.networking.mobile.CellTechnology.fromMobileNetworkType(mobileNetworkType)
    // for 4G cells we want to have it marked as 4G not 5G also in case when it is NR_NSA
    val cellTechnology =
        if (this is CellLte && cellTechnologyFromNetworkType == com.cadrikmdev.core.domain.networking.mobile.CellTechnology.CONNECTION_5G) {
            com.cadrikmdev.core.domain.networking.mobile.CellTechnology.CONNECTION_4G
        } else {
