...
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MAX
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MIN
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.calculateCellSignalLevel
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfo.Companion.calculateNRSignalLevel
import com.cadrikmdev.core.connectivty.domain.connectivity.SignalStrengthInfoCommon
import com.cadrikmdev.core.connectivty.domain.connectivity.TransportType
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.CellNetworkInfo
...
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.NrConnectionState
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.PrimaryDataSubscription
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.CellBand
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.CellBand.Companion.fromChannelNumber
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.CellChannelAttribution
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.signal.SignalStrengthInfoGsm
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.signal.SignalStrengthInfoLte
import com.cadrikmdev.core.connectivty.domain.connectivity.mobile.signal.SignalStrengthInfoNr
import com.cadrikmdev.core.database.entity.CellInfoEntity
import com.cadrikmdev.core.database.entity.CellLocationEntity
import com.cadrikmdev.core.database.entity.SignalEntity
...
fun ICell.toRecords(
...
): Map<CellInfoEntity?, SignalEntity?> {
    ...
    val map = HashMap<CellInfoEntity?, SignalEntity?>()
    var cellInfoRecord: CellInfoEntity? = null
    var signalRecord: SignalEntity? = null
    cellTechnology?.let {
        val uuid = this.uuid()
        if (isInformationCorrect(cellTechnology)) {
            cellInfoRecord = CellInfoEntity(
                testUUID = testUUID,
                signalChunkId = signalChunkId,
                uuid = uuid,
                isActive = this.connectionStatus is PrimaryConnection,
                cellTechnology = toTechnologyClass().connectionName,
                transportType = TransportType.CELLULAR.value,
            ...
            signalRecord = this.signal?.toSignalEntity(
                testUUID,
                signalChunkId,
                uuid,
                mobileNetworkType,
...
//    Timber.d("Signal saving time 1: $currentTime  starting time: $testStartTimeNanos   current time: ${System.nanoTime()}")
    ...
    return SignalEntity(
        ...
        mobileNetworkType = mobileNetworkType.intValue,
        transportType = TransportType.CELLULAR.value,
        nrConnectionState = nrConnectionState.stringValue,
        nrCsiRsrp = nrCsiRsrp,
        nrCsiRsrq = nrCsiRsrq,
        nrCsiSinr = nrCsiSinr,
        nrSsRsrp = nrSsRsrp,
...
fun ICell.toCellNetworkInfo(
    ...
    return CellNetworkInfo(
        ...
        nrConnectionState = if (dataTelephonyManager != null) {
            NrConnectionStateResolver.getNRConnectionState(dataTelephonyManager)
...
fun ICell.frequency(): Double? {
    return when (band) {
        ...
        is BandGsm -> com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.BandCalculationUtil.getBandFromArfcn((band as BandGsm).arfcn)?.frequencyDL
        is BandLte -> com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.BandCalculationUtil.getBandFromEarfcn((band as BandLte).downlinkEarfcn)?.frequencyDL
        is BandTdscdma -> com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.BandCalculationUtil.getBandFromUarfcn((band as BandTdscdma).downlinkUarfcn)?.frequencyDL
        is BandWcdma -> com.cadrikmdev.core.connectivty.domain.connectivity.mobile.band.BandCalculationUtil.getBandFromUarfcn((band as BandWcdma).downlinkUarfcn)?.frequencyDL
        else -> null
    }
}
...
fun ICell.mobileNetworkType(netMonster: INetMonster): MobileNetworkType {
    ...
    try {
        networkTypeFromNM = netMonster.getNetworkType(
            this.subscriptionId,
