...
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MAX
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.CELLULAR_SIGNAL_MIN
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.LTE_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.NR_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.TDSCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MAX
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.WCDMA_RSRP_SIGNAL_MIN
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.calculateCellSignalLevel
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfo.Companion.calculateNRSignalLevel
import com.cadrikmdev.core.domain.connectivity.SignalStrengthInfoCommon
import com.cadrikmdev.core.domain.connectivity.TransportType
import com.cadrikmdev.core.domain.connectivity.mobile.CellNetworkInfo
import com.cadrikmdev.core.domain.connectivity.mobile.CellTechnology
import com.cadrikmdev.core.domain.connectivity.mobile.MobileNetworkType
import com.cadrikmdev.core.domain.connectivity.mobile.NrConnectionState
import com.cadrikmdev.core.domain.connectivity.mobile.PrimaryDataSubscription
import com.cadrikmdev.core.domain.connectivity.mobile.band.BandCalculationUtil
import com.cadrikmdev.core.domain.connectivity.mobile.band.CellBand
import com.cadrikmdev.core.domain.connectivity.mobile.band.CellBand.Companion.fromChannelNumber
import com.cadrikmdev.core.domain.connectivity.mobile.band.CellChannelAttribution
import com.cadrikmdev.core.domain.connectivity.mobile.signal.SignalStrengthInfoGsm
import com.cadrikmdev.core.domain.connectivity.mobile.signal.SignalStrengthInfoLte
import com.cadrikmdev.core.domain.connectivity.mobile.signal.SignalStrengthInfoNr
...
fun ICell.toRecords(
    ...
    val cellTechnologyFromNetworkType =
        com.cadrikmdev.core.domain.connectivity.mobile.CellTechnology.fromMobileNetworkType(mobileNetworkType)
    // for 4G cells we want to have it marked as 4G not 5G also in case when it is NR_NSA
    val cellTechnology =
        if (this is CellLte && cellTechnologyFromNetworkType == com.cadrikmdev.core.domain.connectivity.mobile.CellTechnology.CONNECTION_5G) {
            com.cadrikmdev.core.domain.connectivity.mobile.CellTechnology.CONNECTION_4G
        } else {
